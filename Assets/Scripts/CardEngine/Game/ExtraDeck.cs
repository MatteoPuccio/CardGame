...
{
    public sealed class ExtraDeck : ICardZone
    {
        private readonly CardCollection _cards;
        private readonly Player _owner;
        private readonly GameState _gameState;

        public string ZoneName => ZoneNames.ExtraDeck;
        ...
        public ExtraDeck(Player owner = null, GameState gameState = null, List<Card> cards = null)
        {
            _owner = owner;
        ...
        public bool CanEnter(Card card)
        {
            ...
            return card.Category == CardType.Ritual || card.Category == CardType.Avatar;
        }
